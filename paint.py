...
COOKIETIMEOUT = 2
#For QOJ
PAINTBOARDURL = "https://qoj.fzoi.top/paintBoard"
#For UOJ
#PAINTBOARDURL = "https://www.fzoi.top/paintBoard"
...
def paint(x, y, col):
	...
	try:
		#For QOJ
		response = requests.post("https://qoj.fzoi.top/api/paint", data = data, headers = headers, timeout = POSTTIMEOUT)
		#For UOJ
		#response = requests.post("https://www.fzoi.top/api/paint", data = data, headers = headers, timeout = POSTTIMEOUT)
	except:
